...
CREATE TABLE IF NOT EXISTS `item_exhibit_summary`(
    ...
    `display` INT(12) DEFAULT 0 NOT NULL COMMENT '展现量',
    `click` INT(12) DEFAULT 0 NOT NULL COMMENT '点击量',
    `subscribe` INT(12) DEFAULT 0 NOT NULL COMMENT '订阅量',
    `read` INT(12) DEFAULT 0 NOT NULL COMMENT '阅读量',
    `retent` INT(12) DEFAULT 0 NOT NULL COMMENT '留存量',
    `clickDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '点展比',
    `subsClick` FLOAT DEFAULT 0 NOT NULL COMMENT '订点比',
    `subsDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '订展比',
    `readSubs` FLOAT DEFAULT 0 NOT NULL COMMENT '阅订比',
    `readDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '阅展比',
    `retention` FLOAT DEFAULT 0 NOT NULL COMMENT '留存率',
    `retentDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '留展比',
...
CREATE TABLE IF NOT EXISTS `item_exhibit_strategy`(
    ...
    `subscribe` INT(12) DEFAULT 0 NOT NULL COMMENT '订阅量',
    `read` INT(12) DEFAULT 0 NOT NULL COMMENT '阅读量',
    `retention` INT(12) DEFAULT 0 NOT NULL COMMENT '留存量',
    `clickDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '点展比',
    `subsClick` FLOAT DEFAULT 0 NOT NULL COMMENT '订点比',
    `subsDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '订展比',
    `readSubs` FLOAT DEFAULT 0 NOT NULL COMMENT '阅订比',
...
CREATE TABLE IF NOT EXISTS `item_exhibit_classify1`(
    ...
    `retentDisp` FLOAT DEFAULT 0 NOT NULL COMMENT '留展比',
    `feeCate` INT(12) DEFAULT 0 NOT NULL COMMENT '付费类型: 1免费 2付费 3包月 4公版 5限免',
    `classify1Cate` INT(12) DEFAULT 0 NOT NULL COMMENT '一级分类: 1男频 2女频 3出版 4其它',
    `typeCate` INT(12) DEFAULT 0 NOT NULL COMMENT '类型: 1书架推荐 2免费-猜你喜欢 3章末页-读本书还看过 4封面页-读本书还看过 5书架-猜你喜欢 6精选-瀑布流 7封面页-读本书人看过更多 8包月-瀑布流 9封面页-类别推荐 10封面页-作者推荐 11精选-完结瀑布流 12免费-包月推荐 13精选-男频瀑布流 14精选-排行瀑布流 15精选-女频瀑布流 16根据阅读推荐 17退出拦截推荐',
    `timeStamp` INT(10) NOT NULL COMMENT '时间戳20180110',
    PRIMARY KEY (`dzid`)
    );
