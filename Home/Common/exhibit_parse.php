...
function to_chinese_character($str) {
    $trans = array(
        ...
        'shfRecMdl' => '书架推荐', 'freGusMdl' => '免费-猜你喜欢', 'bakArdMdl' => '章末页-读本书的人还看过', 'foeArdMdl' => '封面页-读本书的人还看过', 'shfGusMdl' => '书架-猜你喜欢', 'chsStmMdl' => '精选-瀑布流', 'foeArdMorMdl' => '封面页-读本书的人还看过更多', 'monStmMdl' => '包月瀑布流', 'foeCtgMdl' => '封面页-类别推荐', 'foeAutMdl' => '封面页-作者推荐', 'chsFinStmMdl' => '精选-完结瀑布流', 'chsGilStmMdl' => '精选-女频瀑布流', 'freMonRecMdl' => '免费-包月推荐', 'chsBoyStmMdl' => '精选-男频瀑布流', 'chsRakStmMdl' => '精选-排行瀑布流', 'redRecMdl' => '根据阅读推荐', 'extRecMdl' => '退出拦截推荐',
        'chgFee' => '付费', 'freFee' => '免费', 'monFee' => '包月', 'pubFee' => '公版', 'tfFee' => '限免',
        'livStmRec' => '实时流', 'usrKnnRec' => '用户协同', 'codBotRec' => '冷启动', 'popRec' => '流行度', 'itemKnnRec' => '物品协同', 'samCtgRec' => '同分类', 'subMdlRec' => '订阅模型', 'redMdlRec' => '阅读模型', 'cotSimRec' => '内容相似', 'redSimRec' => '阅读同分类', 'cat1SimCtgRec' => '一级同分类',
        ...
        'lesMonIn' => '1月内入库', 'bt1mto3mIn' => '1~3月内入库', 'bt3mto12mIn' => '3~12月内入库', 'bt12mto99mIn' => '12~99月内入库', 'lesMonUpd' => '0~1月未更新', 'bt1mto3mUpd' => '1~3月未更新', 'bt3mto12mUpd' => '3~12月未更新', 'bt12mto99mUdp' => '12~99月未更新',
